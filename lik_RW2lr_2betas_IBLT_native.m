function [negLL,vv,pchoice] = lik_RW2lr_2betas_IBLT_native(parameters, actions, opt1)
...
% opt1: outcomes from only opt1 (see simu_RW2lr_nobias)
...
for t=1:T    
    ...
    %% response model
    p1 = 1./(1+exp(-(beta_w*v_w(t)-beta_l*v_l(t)))); % probability of action 1
