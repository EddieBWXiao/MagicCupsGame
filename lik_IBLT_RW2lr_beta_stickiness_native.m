function [negLL,vv,pchoice] = lik_IBLT_RW2lr_beta_stickiness_native(parameters, actions, outcomes_all)
...
for t=1:T    
    ...
    %% response model
    p1 = 1./(1+exp(-beta*(v_w(t)-v_l(t)+stickiness*stickCode))); % probability of action 1
