function [out]= gridsearch_Bayes1v_1beta(information,choice, v_in, alphabins,betabins, resp_made,fig_yes)

%Bayesian observer where the value comes from combining the marginal
%distributions, not simply subtracting the point estimates
...
prob_ch_left=1./(1+exp(-out.mean_beta.*(v_in(:,1))));
