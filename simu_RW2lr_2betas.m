function [actions, traj] = simu_RW2lr_2betas(params,opt1)
...
for t=1:nt
    ...
    pchoice_opt1 = (1+exp(-(beta_w*v_w(t)-beta_l*v_l(t)))).^-1;%as per Pulcu & Browning 2017
...
%% output
params = struct('alpha_w',alpha_w,'alpha_l',alpha_l,'beta',beta_w,'beta_l',beta_l);
