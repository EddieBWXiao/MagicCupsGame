function [out]= gridsearch_ChoiceKernel(information,choice, start, alphabins,betabins, resp_made,fig_yes)
...
for t=1:T
    ...
    %p1 = 1./(1+exp(-beta*CK(t,1))); % probability of action 1
        %problematic! this is just one side (like Pulcu & Browning)
